package ba.com.app.sdr.test.configuration;
...
import ba.com.app.commons.validation.impl.RequestValidatorImpl;

@Configuration
@ComponentScan(basePackages = { "ba.com.app.sdr.core.mapper" })
